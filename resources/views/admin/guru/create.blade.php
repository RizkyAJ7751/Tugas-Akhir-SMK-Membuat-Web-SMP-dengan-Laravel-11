...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-md">
        <div class="px-6 py-4 border-b border-gray-200">
            ...
            <p class="mt-1 text-sm text-gray-600">Masukkan informasi guru baru yang akan ditampilkan di website</p>
        </div>

        <form method="POST" action="{{ route("admin.guru.store") }}" enctype="multipart/form-data" class="p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                ...
                <div class="space-y-6">
                    <!-- Nama -->
                    <div>
                        <label for="nama" class="block mb-2 text-sm font-medium text-gray-700">Nama Lengkap & Gelar</label>
                        <input
                            type="text"
                            name="nama"
                            id="nama"
                    ...
                    <!-- Bidang -->
                    <div>
                        <label for="bidang" class="block mb-2 text-sm font-medium text-gray-700">Bidang Keahlian</label>
                        <input
                            type="text"
                            name="bidang"
                            id="bidang"
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex justify-center px-6 pt-5 pb-6 mt-1 transition-colors border-2 border-gray-300 border-dashed rounded-lg hover:border-green-400">
                            <div class="space-y-1 text-center">
                                ...
                                <div class="flex text-sm text-gray-600">
                                    <label for="foto" class="relative font-medium text-green-600 bg-white rounded-md cursor-pointer hover:text-green-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-green-500">
                        ...
                        <div id="imagePreview" class="hidden mt-4">
                            <p class="mb-2 text-sm text-gray-600">Preview foto:</p>
