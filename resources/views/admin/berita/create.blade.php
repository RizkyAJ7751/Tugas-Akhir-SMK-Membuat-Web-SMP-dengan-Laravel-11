    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow-md">
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-semibold text-gray-900">Form Tambah Berita</h3>
                <p class="mt-1 text-sm text-gray-600">Masukkan informasi berita baru yang akan ditampilkan di website</p>
            </div>
            ...
            <form method="POST" action="{{ route('admin.berita.store') }}" enctype="multipart/form-data" class="p-6">
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500">URL akan menjadi: <span
                                    class="font-mono text-green-600">{{ url('/berita/') }}/<span
                                        id="slug-preview">url-slug</span></span></p>
                        </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div
                                ...
                                <div class="space-y-1 text-center">
                                    ...
                                    <p class="text-xs text-gray-500">PNG, JPG, JPEG hingga 5MB <br>dan pastikan gambar berupa landscape.</p>
                                </div>
                            </div>

                            <!-- Image Preview -->
                            <div id="imagePreview" class="hidden mt-4">
                                <p class="mb-2 text-sm text-gray-600">Preview gambar:</p>
                        ...
                        <!-- Tanggal -->
                        <div>
                            <label for="tanggal_publikasi" class="block mb-2 text-sm font-medium text-gray-700">
                            ...
                            <input type="date" name="tanggal_publikasi" id="tanggal_publikasi"
                                ...
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors @error('tanggal_publikasi') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <select name="status" id="status"
                                ...
                                <option value="draft" {{ old('status') == 'draft' ? 'selected' : '' }}>Draft (Tidak
                                    Dipublikasi)</option>
                                <option value="published" {{ old('status') == 'published' ? 'selected' : '' }}>Dipublikasi
                                </option>
                            </select>
                            @error('status')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        ...
                        <div class="p-4 rounded-lg bg-gray-50">
                            ...
                            <div class="overflow-hidden bg-white rounded-lg shadow-sm">
                                ...
                                <div class="p-3">
                                    <h5 class="text-sm font-semibold text-gray-900 line-clamp-2" id="preview-title">Judul
                                        Berita</h5>
                                    <p class="mt-1 text-xs text-gray-600" id="preview-date">{{ date('d M Y') }}</p>
                                    <p class="mt-2 text-xs text-gray-600 line-clamp-2" id="preview-content">Konten berita
            ...
            if (input.files && input.files[0]) {
                ...
                reader.onload = function(e) {
                    ...
                    previewImageCard.innerHTML =
                        `<img src="${e.target.result}" alt="Preview" class="object-cover w-full h-32 rounded-lg">`;
                }
