    ...
    <div class="space-y-6">
        ...
        <div class="p-6 text-white shadow-lg bg-gradient-to-r from-green-600 to-green-700 rounded-xl">
            <div class="flex items-center justify-between">
                ...
                <div class="hidden md:block">
                    <img src="<?php echo e(asset('upload/20230419_121535.png')); ?>" alt="Logo" class="w-auto h-16 opacity-80">
                </div>
            </div>
        </div>
            ...
            <div class="p-6 bg-white border-l-4 border-blue-500 rounded-lg shadow-md">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p
                            class="text-2xl font-semibold <?php echo e($stats && ($stats->siswa_aktif > 0 || $stats->tenaga_pengajar > 0)); ?>">
                            <?php echo e($stats && ($stats->siswa_aktif > 0 || $stats->tenaga_pengajar > 0) ? 'Aktif' : 'Kosong'); ?>
            ...
            <div class="p-6 bg-white border-l-4 border-green-500 rounded-lg shadow-md">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900"><?php echo e(\App\Models\KepalaSekolah::count()); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6 bg-white border-l-4 border-purple-500 rounded-lg shadow-md">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900"><?php echo e(\App\Models\Guru::count()); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6 bg-white border-l-4 border-yellow-500 rounded-lg shadow-md">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-semibold text-gray-900"><?php echo e(\App\Models\Berita::count()); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <div class="p-6 bg-white rounded-lg shadow-md">
                ...
                <?php if($kontakTerbaru->count() > 0): ?>
                    <div class="space-y-3">
                        <?php $__currentLoopData = $kontakTerbaru; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kontak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex items-center justify-between p-3 rounded-lg bg-gray-50">
                                <div>
                                    <p class="font-medium text-gray-900"><?php echo e($kontak->nama); ?></p>
                                    <p class="text-sm text-gray-600"><?php echo e(Str::limit($kontak->subjek, 30)); ?></p>
                                </div>
                                <span class="text-xs text-gray-500"><?php echo e($kontak->created_at->diffForHumans()); ?></span>
                            </div>
        ...
        <div class="p-6 bg-white rounded-lg shadow-md">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                <div class="p-4 text-center rounded-lg bg-gray-50">
                    ...
                    <p class="text-lg font-semibold text-gray-900"><?php echo e(app()->version()); ?></p>
                </div>
                <div class="p-4 text-center rounded-lg bg-gray-50">
                    <p class="text-sm text-gray-600">PHP Version</p>
                    <p class="text-lg font-semibold text-gray-900"><?php echo e(PHP_VERSION); ?></p>
                </div>
                <div class="p-4 text-center rounded-lg bg-gray-50">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\smpit-bahrul-ulum-sahlaniyah\resources\views/dashboard.blade.php ENDPATH**/ ?>