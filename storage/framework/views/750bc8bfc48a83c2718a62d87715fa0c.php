...
<?php $__env->startSection('page-title', 'Statistik Sekolah'); ?>
    ...
    <div class="space-y-6">
        ...
        <div class="p-6 bg-white rounded-lg shadow-md">
            <div class="flex items-center justify-between">
                ...
                <div>
                    <a href="<?php echo e(route('admin.stats.edit', $stats->id)); ?>"
                    ...
                    <form action="<?php echo e(route('admin.stats.destroy', $stats->id)); ?>" method="POST" class="inline"
            ...
            <div class="p-6 bg-white border-l-4 border-blue-500 rounded-lg shadow-md">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-3xl font-bold text-gray-900"><?php echo e($stats->siswa_aktif ?? 0); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6 bg-white border-l-4 border-green-500 rounded-lg shadow-md">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-3xl font-bold text-gray-900"><?php echo e($stats->tenaga_pengajar ?? 0); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6 bg-white border-l-4 border-purple-500 rounded-lg shadow-md">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-3xl font-bold text-gray-900"><?php echo e($stats->tahun_berdiri ?? '-'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6 bg-white border-l-4 border-yellow-500 rounded-lg shadow-md">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-3xl font-bold text-gray-900"><?php echo e($stats->akreditasi ?? '-'); ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-6 rounded-lg bg-gray-50">
                <div class="text-center">
                    ...
                    <div class="grid grid-cols-2 gap-4 text-center md:grid-cols-4">
                        <div>
                            <div class="text-2xl font-bold text-green-600"><?php echo e($stats->siswa_aktif ?? '0'); ?></div>
                            <div class="text-sm text-gray-600">Siswa Aktif</div>
                        </div>
                        <div>
                            <div class="text-2xl font-bold text-green-600"><?php echo e($stats->tenaga_pengajar ?? '0'); ?></div>
                            <div class="text-sm text-gray-600">Tenaga Pengajar</div>
                        </div>
                        <div>
                            <div class="text-2xl font-bold text-green-600"><?php echo e($stats->tahun_berdiri ?? '0'); ?></div>
                            <div class="text-sm text-gray-600">Tahun Berdiri</div>
                        </div>
                        <div>
                            <div class="text-2xl font-bold text-green-600"><?php echo e($stats->akreditasi ?? '-'); ?></div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\smpit-bahrul-ulum-sahlaniyah\resources\views/admin/stats/index.blade.php ENDPATH**/ ?>