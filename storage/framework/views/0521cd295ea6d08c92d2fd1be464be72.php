    ...
    <div class="flex items-center justify-center min-h-screen px-4 py-12 sm:px-6 lg:px-8">
        <div class="w-full max-w-md space-y-8">
            ...
            <div class="text-center">
                <img class="w-auto h-20 mx-auto" src="<?php echo e(asset('upload/20230419_121535.png')); ?>" alt="Logo SMP IT Bahrul Ulum Sahlaniyah">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input
                                ...
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors <?php $__errorArgs = ['email'];
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input
                                ...
                                required
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="text-center">
                <p class="text-xs text-gray-500">
                    © <?php echo e(date('Y')); ?> SMP IT Bahrul Ulum Sahlaniyah. All rights reserved.
                </p>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\laragon\www\smpit-bahrul-ulum-sahlaniyah\resources\views/auth/login.blade.php ENDPATH**/ ?>